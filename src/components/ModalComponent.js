...
function ModalComponent({ open, handleClose,setadded,added}) {
 ...
 const handleFormSubmit = async (values) => {
  await apis.postLatestStats(values)
  .then ((response) => {
